...
int main(int /*argc*/, char** /*argv*/) {
    ...
    ForwardEuler forwardEulerIntegrator(&system, t0, dt, tEnd); 
    RungeKutta rungeKuttaIntegrator(&system, t0, dt*20, tEnd); // Note: dt becomes 20 as large, as RungeKutta-4 is more stable than Euler forward.
